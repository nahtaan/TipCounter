const addEmployeeClick = () => {
    ...
    <div class="flex flex-row place-content-center bg-neutral-700 rounded-xl divide-x-2 p-3 divide-neutral-400 min-w-min max-w-full">
        ...
        <div class="pl-2 pr-2 lg:pr-0 lg:pl-0 block whitespace-break-spaces text-clip overflow-hidden">
